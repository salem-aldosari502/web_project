...
const EventFilterPanel = ({ isOpen, onClose, filters, onFilterChange }) => {
  ...
  return (
    <div className="filter-panel">
      ...
      <style>{`
        ...
        .filter-panel-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 12px; }
        ...
        .filter-input[type="date"]::-webkit-calendar-picker-indicator { filter: invert(1); opacity: 0.6; }
